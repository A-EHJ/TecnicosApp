...
fun TecnicoListScreen(
    ...
    val tipoTecnico by viewModel.tiposTecnicos.collectAsStateWithLifecycle()
    ...
    Column(
        ...
        LazyColumn(
            ...
            items(tecnicos) { tecnico ->
                TecnicoRow(onVerTecnico, tecnico, modoEliminarOn, eliminarTecnico, context, tipoTecnico)
            }
        }
    }
...
private fun TecnicoRow(
    ...
    Box(modifier = Modifier
        ...
        Row(
            ...
            Text(text = tipoTecnico.find { it.tipoTecnicoId == tecnico.tipoTecnicoId }!!.descripcion, modifier = Modifier.weight(0.30f))
            if (modoEliminarOn)
